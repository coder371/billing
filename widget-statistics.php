<?php require_once "./inc/static/head.php"; ?>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="card mb-4 o-hidden">
                                <div class="card-body ul-card__widget-chart">
                                    <div class="ul-widget__row-v2">
                                        <div class="ul-widget__content-v2">
                                            <h3 class="heading mt-3">698</h3><small class="text-muted m-0">Orders Received</small>
                                        </div>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="card mb-4 o-hidden">
                                <div class="card-body ul-card__widget-chart">
                                    <div class="ul-widget__row-v2">
                                        <div class="ul-widget__content-v2">
                                            <h3 class="heading mt-3">5,767</h3><small class="text-muted m-0">Total Marketing</small>
                                        </div>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="card mb-4 o-hidden">
                                <div class="card-body ul-card__widget-chart">
                                    <div class="ul-widget__row-v2">
                                        <div class="ul-widget__content-v2">
                                            <h3 class="heading mt-3">$5,767</h3><small class="text-muted m-0">Total Earning</small>
                                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="text-20 text-success line-height-1 mb-3"><i class="i-Arrow-Up-in-Circle"></i> Up</p><small class="text-muted">Last down 4 days ago</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="text-20 text-success line-height-1 mb-3"><i class="i-Arrow-Up-in-Circle"></i> Up</p><small class="text-muted">Last down 8 days ago</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="text-20 text-danger line-height-1 mb-3"><i class="i-Arrow-Down-in-Circle"></i> Down</p><small class="text-muted">Last down 22 days ago</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="text-20 text-danger line-height-1 mb-3"><i class="i-Arrow-Down-in-Circle"></i> Down</p><small class="text-muted">Last down 2 days ago</small>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="progress mb-1" style="height: 4px">
                                        <div class="progress-bar bg-success" style="width: 50%" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div><small class="text-muted">Most data used in last 3 days</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    </div><small class="text-muted">Most data used in last 7 days</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="progress mb-1" style="height: 4px">
                                        <div class="progress-bar bg-warning" style="width: 60%" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div><small class="text-muted">Most data used in last 5 days</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="mb-1 text-22 font-weight-light">60%</p>
                                    <div class="progress mb-1" style="height: 4px">
                                        <div class="progress-bar bg-info" style="width: 60%" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div><small class="text-muted">Most data used in last 4 days</small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3 col-lg-3">
                            <div class="card mb-2 o-hidden">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-7">
                                            <h5 class="t-font-bolder">Helpline</h5><small class="text-muted">26% higher than last year</small>
                                        </div>
                                        <div class="col-5 text-right">
                                            <h3 class="t-font-boldest">62%</h3><small class="text-muted">30GB</small>
                                        </div>
                                        <div class="col-12">
                        ...
                        <div class="col-md-3 col-lg-3">
                            <div class="card mb-2 o-hidden">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-7">
                                            <h5 class="t-font-bolder">Service</h5><small class="text-muted">16% higher than last year</small>
                                        </div>
                                        <div class="col-5 text-right">
                                            <h3 class="t-font-boldest">94</h3><small class="text-muted">30GB</small>
                                        </div>
                                        <div class="col-12">
                                            <div class="progress mt-3">
                        ...
                        <div class="col-md-3 col-lg-3">
                            <div class="card mb-2 o-hidden">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-7">
                                            <h5 class="t-font-bolder">Email</h5><small class="text-muted">16% higher than last year</small>
                                        </div>
                                        <div class="col-5 text-right">
                                            <h3 class="t-font-boldest">120</h3><small class="text-muted">out of 1K</small>
                                        </div>
                                        <div class="col-12">
                                            <div class="progress mt-3">
                        ...
                        <div class="col-md-3 col-lg-3">
                            <div class="card mb-2 o-hidden">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-7">
                                            <h5 class="t-font-bolder">Territory</h5><small class="text-muted">16% higher than last year</small>
                                        </div>
                                        <div class="col-5 text-right">
                                            <h3 class="t-font-boldest">120</h3><small class="text-muted">out of 1K</small>
                                        </div>
                        ...
                        <div class="col-md-12 col-lg-12 mt-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3 col-lg-3">
                                            <div class="ul-widget__content-v4 card-icon-bg"><i class="i-Eye text-success"></i>
                                                <h3 class="t-font-boldest">4,377</h3><span>Viewers</span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-3">
                                            <div class="ul-widget__content-v4 card-icon-bg"><i class="i-Like text-primary"></i>
                                                <h3 class="t-font-boldest">456</h3><span>Likes</span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-3">
                                            <div class="ul-widget__content-v4 card-icon-bg"><i class="i-File-Horizontal-Text text-info"></i>
                                                <h3 class="t-font-boldest">65</h3><span>Comments</span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-3">
                                            <div class="ul-widget__content-v4 card-icon-bg"><i class="i-Business-Man text-warning"></i>
                                                <h3 class="t-font-boldest">20K</h3><span>Views</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="../../dist-assets/js/scripts/card.metrics.script.min.js"></script>
