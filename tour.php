                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <button class="btn btn-large btn-primary" id="startTourBtn">Take a tour</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card text-left" id="create-tour">
                            <div class="card-body">
                                ...
                                <pre><code style="white-space:pre;"> var tour = {
id: "hello-hopscotch",
steps: [
 {
   title: "My Header",
 ...
 // Start the tour!
 hopscotch.startTour(tour);</code></pre>
                            </div>
                        </div>
                    </div>
    ...
    <script src="../../dist-assets/js/plugins/hopscotch.min.js"></script>
    <script src="../../dist-assets/js/scripts/hopscotch.script.min.js"></script>
</body>
