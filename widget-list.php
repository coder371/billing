                    ...
                    <div>
                                    ...
                                    <div class="card-body">
                                        <div class="ul-widget__head">
                                            <div class="ul-widget__head-label">
                                                <h3 class="ul-widget__head-title">Tasks</h3>
                                            </div>
                                            <div class="ul-widget__head-toolbar">
                                                <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold ul-widget-nav-tabs-line ul-widget-nav-tabs-line" role="tablist">
                                                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#ul-widget2-tab1-content" role="tab">Today</a></li>
                                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#ul-widget2-tab2-content" role="tab">Week</a></li>
                                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#ul-widget2-tab3-content" role="tab">Month</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <div class="tab-pane active" id="ul-widget2-tab1-content">
                                                    <div class="ul-widget1">
                                                        <div class="ul-widget2__item">
                                                            ...
                                                            <div class="ul-widget2__info"><a class="ul-widget2__title" href="#">Lorem Ipsum Amet</a><a class="ul-widget2__username" href="#">By Wick</a></div>
                                                            <div class="ul-widget2__actions">
                                                                ...
                                                                <div class="dropdown-menu" x-placement="bottom-start"><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Statistic"> </i> Reports</a><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Email"> </i> Members</a><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Pie-Chart-2"></i> Charts</a><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Business-ManWoman"></i> Members</a><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Gears-2"></i> Settings</a></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="ul-widget1">
                            ...
                            <div class="col-lg-4 col-md-6 col-xl-4 mt-2 mb-2">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="ul-widget__head">
                                            <div class="ul-widget__head-label">
                                                <h3 class="ul-widget__head-title">Notifications</h3>
                                            </div>
                                            <div class="ul-widget__head-toolbar">
                                                <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold" role="tablist">
                                                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#ul-widget3-tab1-content" role="tab">Today</a></li>
                                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#ul-widget3-tab2-content" role="tab">Week</a></li>
                                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#ul-widget3-tab3-content" role="tab">Month</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="ul-widget__body">
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="ul-widget3-tab1-content">
                                                    <div class="ul-widget-notification">
                                                        <div class="ul-widget-notification-item-div"><a class="ul-widget-notification-item" href="#">
                                                                <div class="ul-widget-notification-item-icon"><i class="i-Checkout"></i></div>
                                                                <div class="ul-widget-notification-item-details">
                                                                    <div class="ul-widget-notification-item-title">New order has been received.</div>
                                                                    <div class="ul-widget-notification-item-time">2 hrs ago</div>
                                                                </div>
                                                            </a></div>
                                                        <div class="ul-widget-notification-item-div"><a class="ul-widget-notification-item" href="#">
                                                                <div class="ul-widget-notification-item-icon"><i class="i-Arrow-Refresh"></i></div>
                                                                <div class="ul-widget-notification-item-details">
                                                                    <div class="ul-widget-notification-item-title">Pending Order.</div>
                                                                    <div class="ul-widget-notification-item-time">24 hrs ago</div>
                                                                </div>
                                                            </a></div>
                                                        <div class="ul-widget-notification-item-div"><a class="ul-widget-notification-item" href="#">
                                                                <div class="ul-widget-notification-item-icon"><i class="i-Close-Window"></i></div>
                                                                <div class="ul-widget-notification-item-details">
                                                                    <div class="ul-widget-notification-item-title">Decline Order.</div>
                                                                    <div class="ul-widget-notification-item-time">Today</div>
                                                                </div>
                                                            </a></div>
                                                        <div class="ul-widget-notification-item-div"><a class="ul-widget-notification-item" href="#">
                                                                <div class="ul-widget-notification-item-icon"><i class="i-Checkout"></i></div>
                                        ...
                                        <div class="ul-widget1">
                                            <div class="ul-widget__item">
                                                <div class="ul-widget__info">
                                                    <h3 class="ul-widget1__title">Member Profit</h3><span class="ul-widget__desc text-mute">Average Weekly Profit</span>
                                                </div><span class="ul-widget__number text-primary">+$17,800</span>
                                            </div>
                                            <div class="ul-widget__item">
                                                <div class="ul-widget__info">
                                                    <h3 class="ul-widget1__title">Orders</h3><span class="ul-widget__desc text-mute">Weekly Customer Orders</span>
                                                </div><span class="ul-widget__number text-danger">+1,800</span>
                                            </div>
                                            <div class="ul-widget__item">
                                                <div class="ul-widget__info">
                                                    <h3 class="ul-widget1__title">Issue Reports</h3><span class="ul-widget__desc text-mute">System bugs and issues</span>
                                                </div><span class="ul-widget__number text-success">-27,49%</span>
                                            </div>
                                        </div>
                                        <!-- end::widget-stats-1-->
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="ul-widget1">
                                            <div class="ul-widget__item">
                                                <div class="ul-widget__info">
                                                    <h3 class="ul-widget1__title">IPO Margin</h3><span class="ul-widget__desc text-mute">Average IPO Margin</span>
                                                </div><span class="ul-widget__number text-primary">+24%</span>
                                            </div>
                                            <div class="ul-widget__item">
                                                <div class="ul-widget__info">
                                                    <h3 class="ul-widget1__title">Payments</h3><span class="ul-widget__desc text-mute">Yearly Expenses</span>
                                                </div><span class="ul-widget__number text-danger">+$560,800</span>
                                            </div>
                                            <div class="ul-widget__item">
                                                <div class="ul-widget__info">
                                                    <h3 class="ul-widget1__title">Issue Reports</h3><span class="ul-widget__desc text-mute">Overall Regional Logistics</span>
                                                </div><span class="ul-widget__number text-success">-10%</span>
                                            </div>
                                        </div>
                                        <!-- end::widget-stats-1-->
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="ul-widget1">
                                            <div class="ul-widget__item">
                                                <div class="ul-widget__info">
                                                    <h3 class="ul-widget1__title">Transactions</h3><span class="ul-widget__desc text-mute">Daily Transaction Increase</span>
                                                </div><span class="ul-widget__number text-primary">+80%</span>
                                            </div>
                                            <div class="ul-widget__item">
                                                <div class="ul-widget__info">
                                                    <h3 class="ul-widget1__title">Orders</h3><span class="ul-widget__desc text-mute">Average Weekly Orders</span>
                                                </div><span class="ul-widget__number text-danger">+15%</span>
                                            </div>
                                            <div class="ul-widget__item">
                                                <div class="ul-widget__info">
                                                    <h3 class="ul-widget1__title">Revenue</h3><span class="ul-widget__desc text-mute">Overall Revenue Increase</span>
                                                </div><span class="ul-widget__number text-success">+60%</span>
                                            </div>
                                        </div>
                                        <!-- end::widget-stats-1-->
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="ul-widget__head pb-20 v-margin">
                                            ...
                                            <button class="btn btn-info dropdown-toggle _r_btn border-0" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Latest</button>
                                        ...
                                        <div class="ul-widget__body">
                                            <div class="ul-widget1">
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__img"><img id="userDropdown" src="../../dist-assets/images/faces/1.jpg" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Anna Strong</a><span class="ul-widget2__username" href="#">Visual Designer,Google Inc</span></div><span class="ul-widget4__number t-font-boldest text-success">+500</span>
                                                </div>
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__img"><img id="userDropdown" src="../../dist-assets/images/faces/2.jpg" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Will Smith</a><span class="ul-widget2__username" href="#">Developer</span></div><span class="ul-widget4__number t-font-boldest text-danger">+900</span>
                                                </div>
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__img"><img id="userDropdown" src="../../dist-assets/images/faces/3.jpg" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Will Smith</a><span class="ul-widget2__username" href="#">Developer</span></div><span class="ul-widget4__number t-font-boldest text-primary">+700</span>
                                                </div>
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__img"><img id="userDropdown" src="../../dist-assets/images/faces/4.jpg" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Megan Fox</a><span class="ul-widget2__username" href="#">UI/UX</span></div><span class="ul-widget4__number t-font-boldest text-warning">+100</span>
                                                </div>
                                                <!--
                          <div class="ul-widget4__item ul-widget4__users">
                          <div class="ul-widget4__img">
                          <img src="../../dist-assets/images/faces/5.jpg" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="ul-widget__head v-margin pb-20">
                                            <div class="ul-widget__head-label">
                                                <h3 class="ul-widget__head-title">Download Files</h3>
                                            </div>
                                            <button class="btn btn-info dropdown-toggle _r_btn border-0" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Latest</button>
                                            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 33px, 0px); top: 0px; left: 0px; will-change: transform;"><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Bar-Chart-4"> </i> Export</a><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Data-Save"> </i> Save</a><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Duplicate-Layer"></i> Import</a>
                                                <div class="dropdown-divider"></div><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Folder-Download"></i> Update</a><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Gears-2"></i> Customize</a>
                                        ...
                                        <div class="ul-widget__body">
                                            <div class="__g-widget4">
                                                <div class="ul-widget4__item">
                                                    <div class="ul-widget4__pic-icon"><i class="i-Folder-With-Document text-info"></i></div><a class="ul-widget4__title" href="#">Documentation</a>
                                                </div>
                                                <div class="ul-widget4__item">
                                                    <div class="ul-widget4__pic-icon"><i class="i-File-CSV text-success"></i></div><a class="ul-widget4__title" href="#">Full Developer Manual For 4.7</a>
                                                </div>
                                                <div class="ul-widget4__item">
                                                    <div class="ul-widget4__pic-icon"><i class="i-File-Zip text-danger"></i></div><a class="ul-widget4__title" href="#">Download Ziped version OF 5.0</a>
                                                </div>
                                                <div class="ul-widget4__item">
                                                    <div class="ul-widget4__pic-icon"><i class="i-File-JPG text-warning"></i></div><a class="ul-widget4__title" href="#">Project Launch Event</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="ul-widget__head pb-20 v-margin">
                                            <div class="ul-widget__head-label">
                                                <h3 class="ul-widget__head-title">Latest Updates</h3>
                                            </div>
                                            <button class="btn btn-info dropdown-toggle _r_btn border-0" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Latest</button>
                                            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 33px, 0px); top: 0px; left: 0px; will-change: transform;"><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Bar-Chart-4"> </i> Export</a><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Data-Save"> </i> Save</a><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Duplicate-Layer"></i> Import</a>
                                                <div class="dropdown-divider"></div><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Folder-Download"></i> Update</a><a class="dropdown-item ul-widget__link--font" href="#"><i class="i-Gears-2"></i> Customize</a>
                                        ...
                                        <div class="ul-widget__body">
                                            <div class="ul-widget1">
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__pic-icon"><i class="i-Folder-With-Document text-info"></i></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget4__title" href="#">New Version</a></div><span class="ul-widget4__number t-font-boldest text-success">+500</span>
                                                </div>
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__pic-icon"><i class="i-Folder-Add- text-success"></i></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget4__title" href="#">Old Version</a></div><span class="ul-widget4__number t-font-boldest text-info">+500</span>
                                                </div>
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__pic-icon"><i class="i-Folder-Binder text-danger"></i></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget4__title" href="#">Old Version 2</a></div><span class="ul-widget4__number t-font-boldest text-warning">+333</span>
                                                </div>
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__pic-icon"><i class="i-Folder-Download text-warning"></i></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget4__title" href="#">Donwload New Version</a></div><span class="ul-widget4__number t-font-boldest text-danger">+200</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-12 col-xl-4 mt-2 mb-2">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="ul-widget__head v-margin pb-20">
                                            <div class="ul-widget__head-label">
                                                <h3 class="ul-widget__head-title">Support Tickets</h3>
                                            </div>
                                            ...
                                            <div class="ul-widget3">
                                                <div class="ul-widget3-item">
                                                    <div class="ul-widget3-header">
                                                        ...
                                                        <div class="ul-widget3-info"><a class="__g-widget-username" href="#"><span class="t-font-bolder">Timithy Clarkson</span></a><br /><span class="ul-widget-notification-item-time">2 hrs ago</span></div><span class="ul-widget3-status text-success t-font-bolder">Pending</span>
                                                    </div>
                                                ...
                                                <div class="ul-widget3-item">
                                                    <div class="ul-widget3-header">
                                                        <div class="ul-widget3-img"><img id="userDropdown" src="../../dist-assets/images/faces/2.jpg" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                        <div class="ul-widget3-info"><a class="__g-widget-username" href="#"><span class="t-font-bolder">Jannet Clarkson</span></a><br /><span class="ul-widget-notification-item-time">12 hrs ago</span></div><span class="ul-widget3-status text-danger t-font-bolder">Decline</span>
                                                    </div>
                                                    <div class="ul-widget3-body">
                                                        <p class="ul-widget3-text text-mute">
                                                            Lorem ipsum dolor sit amet,consectetuer edipiscing
                                                ...
                                                <div class="ul-widget3-item">
                                                    <div class="ul-widget3-header">
                                                        <div class="ul-widget3-img"><img id="userDropdown" src="../../dist-assets/images/faces/3.jpg" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                        <div class="ul-widget3-info"><a class="__g-widget-username" href="#"><span class="t-font-bolder">William Shake</span></a><br /><span class="ul-widget-notification-item-time">Today</span></div><span class="ul-widget3-status text-warning t-font-bolder">Processing</span>
                                                    </div>
                                                    <div class="ul-widget3-body">
                                                        <p class="ul-widget3-text text-mute">
                                                            Lorem ipsum dolor sit amet,consectetuer edipiscing
                                        ...
                                        <div class="ul-widget__body">
                                            <div class="ul-widget6">
                                                <div class="ul-widget6__head">
                                                    <div class="ul-widget6__item"><span>Scheduled</span><span>Count</span><span>Amount</span></div>
                                                </div>
                                                <div class="ul-widget6__body">
                                                    <div class="ul-widget6__item"><span>16/13/17</span><span>67</span><span class="t-font-boldest text-success">$14,740</span></div>
                                                    <div class="ul-widget6__item"><span>02/28/17</span><span>120</span><span class="t-font-boldest text-danger">$14,740</span></div>
                                                    <div class="ul-widget6__item"><span>02/28/17</span><span>120</span><span class="t-font-boldest text-warning">$14,740</span></div>
                                                    <div class="ul-widget6__item"><span>02/28/17</span><span>120</span><span class="t-font-boldest text-primary">$14,740</span></div>
                                                    <div class="ul-widget6__item"><span>02/28/17</span><span>120</span><span class="t-font-boldest text-dark">$14,740</span></div>
                                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="ul-widget__head">
                                            ...
                                            <div class="ul-widget__head-toolbar">
                                                <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold ul-widget-nav-tabs-line" role="tablist">
                                                    <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#__g-widget-s5-tab1-content" role="tab" aria-selected="true">Latest</a></li>
                                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#__g-widget-s5-tab2-content" role="tab" aria-selected="false">Month</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="ul-widget__body">
                                            <div class="tab-content">
                                                    ...
                                                    <div class="ul-widget5">
                                                        <div class="ul-widget-s5__item mb-5">
                                                            <div class="ul-widget-s5__content">
                                                                <div class="ul-widget-s5__pic"><img id="userDropdown" src="../../dist-assets/images/faces/1.jpg" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                            ...
                                                            <div class="ul-widget-s5__content">
                                                                <div class="ul-widget-s5__progress">
                                                                    ...
                                                                    <div class="progress mb-3">
                                                                        <div class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: 50%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">50%</div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="ul-widget-s5__item mb-5">
                                                            <div class="ul-widget-s5__content">
                                                                <div class="ul-widget-s5__pic"><img id="userDropdown" src="../../dist-assets/images/faces/2.jpg" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                                <div class="ul-widget-s5__section"><a class="ul-widget4__title" href="#">Great Logo Designn</a>
                                                                    <p class="ul-widget-s5__desc">UI LIb admin themes.</p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="ul-widget-s5__item mb-5">
                                                            <div class="ul-widget-s5__content">
                                                                <div class="ul-widget-s5__pic"><img id="userDropdown" src="../../dist-assets/images/faces/3.jpg" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                            ...
                                                            <div class="ul-widget-s5__content">
                                                                <div class="ul-widget-s5__progress">
                                                                    ...
                                                                    <div class="progress mb-3">
                                                                        <div class="progress-bar progress-bar-striped bg-warning" role="progressbar" style="width: 30%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">30%</div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="tab-pane" id="__g-widget-s5-tab2-content">
                                                    <div class="ul-widget5">
                                                        <div class="ul-widget-s5__item mb-5">
                                                            <div class="ul-widget-s5__content">
                                                                <div class="ul-widget-s5__pic"><img id="userDropdown" src="../../dist-assets/images/faces/5.jpg" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                                <div class="ul-widget-s5__section"><a class="ul-widget4__title" href="#">Great Logo Designn</a>
                                                                    <p class="ul-widget-s5__desc">UI LIb admin themes.</p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="ul-widget-s5__item mb-5">
                                                            <div class="ul-widget-s5__content">
                                                                <div class="ul-widget-s5__pic"><img id="userDropdown" src="../../dist-assets/images/faces/4.jpg" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                                <div class="ul-widget-s5__section"><a class="ul-widget4__title" href="#">Great Logo Designn</a>
                                                                    <p class="ul-widget-s5__desc">UI LIb admin themes.</p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="ul-widget-s5__item mb-5">
                                                            ...
                                                            <div class="ul-widget-s5__content">
                                                                <div class="ul-widget-s5__progress">
                                                                    <div class="ul-widget-s5__stats"><span>50%</span><span>Finland</span></div>
                                                                    <div class="progress mb-3">
                                                                        <div class="progress-bar progress-bar-striped bg-warning" role="progressbar" style="width: 50%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">30%</div>
                                                                    </div>
                                                                </div>
                                                                <button class="btn btn-outline-danger" type="button">Follow</button>
                                                            </div>
                        ...
                        <div class="row">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">666</th>
                                                        <td><span class="text-15 font-weight-200">Dan brown on the North</span><br /></td>
                                                        <td><span class="badge badge-primary w-badge">Developing</span></td>
                                                        <td>
                                                            <div id="chart13"></div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><span class="text-15 font-weight">Lucy Loki</span><br /></td>
                                                        <td><span class="badge badge-danger w-badge">Backend</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="text-15 font-weight-200">Dan</span><br /></td>
                                                        <td><span class="badge badge-success w-badge">Frontend</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="text-15 font-weight-200">Jaret Leto</span><br /></td>
                                                        <td><span class="badge badge-warning w-badge">Backend</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="text-15 font-weight-200">White Walker</span><br /></td>
                                                        <td><span class="badge badge-dark w-badge">Fullstack</span></td>
                                                        <td>
                            ...
                            <div class="col-lg-6 col-xl-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="ul-widget-list__payment-method mb-3"><img src="../../dist-assets/images/master-card.png" style="width: 50px" alt="" srcset="" /><img src="../../dist-assets/images/visa.png" style="width: 50px" alt="" srcset="" /><img src="../../dist-assets/images/paypal.png" style="width: 50px" alt="" srcset="" /></div>
                                            ...
                                            <form action="">
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="i-Male-21 text-18"></i></span></div>
                                                                <input class="form-control" type="text" placeholder="" aria-label="Username" aria-describedby="basic-addon1" />
                                                            </div><small class="ul-form__text form-text" id="passwordHelpBlock">Some help content goes here</small>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                            <label class="ul-form__label" for="inputEmail4">Card Number:</label>
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="i-Credit-Card-2 text-18"></i></span></div>
                                                                <input class="form-control" type="text" placeholder="" aria-label="Username" aria-describedby="basic-addon1" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-8">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-inline">
                                                                    ...
                                                                    </select><span class="text-center" style="width:10%">/</span>
                                                                    <select class="form-control" style="width:45%">
                                                                        <option>Year</option>
                                                                        <option>2018</option>
                                                                        <option>2019</option>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                <label class="font-weight-700 text-dark" data-toggle="tooltip" data-placement="top" title="" data-original-title="6 digits code on back side of the card">CVV</label>
                                                                <input class="form-control" required="" type="text" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <button class="btn btn-primary btn-block m-1 mb-3" type="button">Confirm</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-xl-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-title">Payment Form #02as</div>
                                        <p class="alert alert-danger">Some text success or error</p>
                                        <div class="card-body">
                                            <ul class="nav nav-pills nav-fill mb-3" id="pills-tab" role="tablist">
                                                <li class="nav-item"><a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"><i class="i-Credit-Card-2 text-16 mr-2 align-middle"></i> Credit Card</a></li>
                                                <li class="nav-item"><a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-profile" aria-selected="false"><i class="i-Paypal text-16 mr-2 align-middle"></i> Paypal</a></li>
                                                <li class="nav-item"><a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-contact" aria-selected="false"><i class="i-Bank text-16 mr-2 align-middle"></i><span>Bank Transaction</span></a></li>
                                            </ul>
                                                    ...
                                                    <div class="ul-widget__payment-form">
                                                        <form action="">
                                                            <div class="card-body">
                                                                ...
                                                                <button class="btn btn-primary btn-block m-1" type="button">Confirm</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
