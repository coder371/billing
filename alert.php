    ...
    <div class="app-admin-wrap layout-sidebar-large">
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-card alert-warning text-center" role="alert">Gull makes developent life easier!
                            <button class="btn btn-rounded btn-warning ml-3">Buy Now</button>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="alert alert-card alert-danger" role="alert"><strong class="text-capitalize">Danger!</strong> Lorem ipsum dolor sit amet.
                            <button class="close" type="button" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        </div>
                        <div class="alert alert-card alert-info" role="alert"><strong class="text-capitalize">Success!</strong> Lorem ipsum dolor sit amet.
                            <button class="close" type="button" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        </div>
                    </div>
                    <div class="col-md-12">
