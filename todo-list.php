<?php require_once "./inc/static/head.php"; ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="pr-3 pb-3"><i class="todo-sidebar-close i-Close pb-3 text-right" data-sidebar-toggle="main"></i>
                                    <!-- Large modal-->
                                    <button class="btn btn-primary btn-block mb-4" type="button" data-toggle="modal" data-target=".bd-example-modal-lg">Add Task</button>
                                    <div>
                                        <p class="text-muted mb-2">Filters</p>
                                        <ul class="list-group">
                                            <li class="list-group-item border-0"><a href=""><i class="icon-regular i-Find-User mr-2"></i> Find</a></li>
                                            <li class="list-group-item border-0"><a href=""><i class="icon-regular i-Favorite-Window mr-2"></i> Favourite</a></li>
                                            <li class="list-group-item border-0"><a href=""><i class="icon-regular i-Delete-File mr-2"></i> Deleted</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="ul-todo-body">
                                            <ul class="list-group list-group-flush" id="userTable"></ul>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="../../dist-assets/js/plugins/todo-list.min.js"></script>
</body>
