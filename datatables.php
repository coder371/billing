                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <p>DataTables allows ordering by multiple columns at the same time, which can be activated in a number of</p>
                                <p>
                                    There are times when you might find it useful to display only a sub-set of the information that was available in the original table. For example you might want to reduce the amount of data shown on screen to make it clearer
                                    for the user (consider also using the <a href="https://datatables.net/extensions/responsive">
                                        Responsive
                                        extension</a> for this). This is done through the <a href="//datatables.net/reference/option/columns.visible"><code class="option" title="DataTables initialisation option">columns.visible</code></a> column option.
                                </p>
                                <div class="table-responsive">
                                    <table class="display table table-striped table-bordered" id="hidden_column_table" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Position</th>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <p>When using tables to display data, you will often wish to display column information in groups. DataTables fully supports <code>colspan</code> and<code>rowspan</code> in the table&apos;s header, assigning the required order listeners to the TH element suitable for that column.</p>
                                <div class="table-responsive">
                                    <table class="display table table-striped table-bordered" id="complex_header_table" style="width:100%">
                                        <thead>
                                            <tr>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <p>
                                    When customising DataTables for your own usage, you might find that the default position of the feature elements (filter input etc) is not quite to your liking. To address this issue DataTables takes inspiration from the CSS
                                    3 Advanced Layout Module and provides the<a href="//datatables.net/reference/option/dom"><code class="option" title="DataTables initialisation option">dom</code></a> initialisation parameter which can be set to indicate where you wish particular features to appear
                                    in the DOM. You can also specify <code>div</code> wrapping containers (with an id and / or class) to provide complete layout flexibility.
                                </p>
                                <div class="table-responsive">
                                    <table class="display table table-striped table-bordered" id="dom_positioning_table" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Position</th>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <p>
                                    This example shows the DataTables table body scrolling in the vertical direction. This can generally be seen as an alternative method to pagination for displaying a large table in a fairly small vertical area, and as such pagination
                                    has been disabled here (note that this is not mandatory, it will work just fine with pagination enabled as well!).
                                </p>
                                <div class="table-responsive">
                                    <table class="display table table-striped table-bordered" id="scroll_vertical_table" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Position</th>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <p>This example shows a vertically scrolling DataTable that makes use of the CSS3 <code>vh</code> unit in order to dynamically resize the viewport based on the browser window height. The <a href="https://developer.mozilla.org/en/docs/Web/CSS/length#Viewport-percentage_lengths"><code>vh</code> unit</a> is effectively a percentage of the browser window height. So the <code>50vh</code> used in this example is 50% of the window height. The viewport size will update dynamically as the window is resized.</p>
                                <div class="table-responsive">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <p>DataTables has the ability to show tables with horizontal scrolling, which is very useful for when you have a wide table, but want to constrain it to a limited horizontal display area. To enable x-scrolling simply set the<a href="//datatables.net/reference/option/scrollX"><code class="option" title="DataTables initialisation option">scrollX</code></a> parameter to be whatever you want the container wrapper&apos;s width to be (this should be
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <p>A dot (<code>.</code>) is used to mark the decimal place in Javascript, however, <a href="http://en.wikipedia.org/wiki/Decimal_mark">
                                        many
                                        parts of the world
