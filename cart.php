                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td scope="row"><img class="profile-picture avatar-sm mb-2 img-fluid" src="assets/images/faces/1.jpg" alt="" />
                                                        <div class="ul-product-cart__detail d-inline-block align-middle ml-1"><a href="">
                                                    ...
                                                    <td>$8,000</td>
                                                    <td><a href=""><i class="i-Close-Window text-19 text-danger font-weight-700"></i></a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <div class="col-lg-6 mt-5">
                                            <div class="ul-product-cart__invoice">
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-16 text-success font-weight-700">$5,000</td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <ul class="list-unstyled mb-0">
                                                                    ...
                                                                    <li><a class="text-dark font-weight-bold" href="">Change Address</a></li>
                                                                </ul>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <div class="ul-product-cart__button text-right">
                                                    <button class="btn btn-primary ripple m-1" type="button">Checkout</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
