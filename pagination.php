            ...
            <div class="main-content">
                ...
                <div class="row mb-4">
                    <div class="col-md-4 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <h4 class="card-title mb-2">Default Pagination</h4>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <h4 class="card-title mb-2">Pagination With Icons</h4>
                    ...
                    <div class="col-md-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <h4 class="card-title mb-2">Pagination With Active state</h4>
                                <p>Pagination links are customizable for different circumstances. Use<code>.active</code>for links that appear un-clickable.</p>
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                ...
                <div class="row mb-4">
                    <div class="col-md-4 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <h4 class="card-title mb-2">Pagination With disabled state</h4>
                                <p>Pagination links are customizable for different circumstances. Use<code>.disabled</code> for links that appear un-clickable.</p>
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <h4 class="card-title mb-2">Center Alignment Pagination</h4>
                                <p>
                    ...
                    <div class="col-md-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <h4 class="card-title mb-2">Right Alignment Pagination</h4>
                                <p>
                                    Change the alignment of pagination components with flexbox utilities.
                ...
                <div class="row mb-4">
                    <div class="col-md-4 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <h4 class="card-title mb-2">Left Alignment Pagination</h4>
                                <p>
                                    Change the alignment of pagination components with flexbox utilities.
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <h4 class="card-title mb-2">Large Pagination</h4>
                    ...
                    <div class="col-md-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <h4 class="card-title mb-2">Small Pagination</h4>
