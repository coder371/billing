...
$(document).ready(function () {
  ...
  if (echartElemBar) {
    ...
    echartBar.setOption({
      ...
      xAxis: [{
        type: 'category',
        data: ['يناير', 'فبراير', 'مارس', 'ابريل', 'مايو', 'يونيو', 'يوليو', 'اغسطس', 'سبتمير', 'اكتوبر', 'نوفمبر', 'ديسمبر'],
        axisTick: {
          alignWithLabel: true
        },
        splitLine: {
  ...
  if (echartElem1) {
    ...
    echart1.setOption(_objectSpread({}, echartOptions.lineFullWidth, {}, {
      series: [_objectSpread({
        data: [analytics["day6"], analytics["day5"], analytics["day4"], analytics["day3"],analytics["day2"] ,analytics["day1"], analytics["day0"]]
  ...
  if (echartElem2) {
    ...
    echart2.setOption(_objectSpread({}, echartOptions.lineFullWidth, {}, {
      series: [_objectSpread({
        data: [30, 10, 40, 10, 40, 20, 0,10,12,54,354,21,34,21,36,782,34,35,41]
      }, echartOptions.smoothLine, {
        markArea: {
          label: {
            show: true
  ...
  if (echartElem3) {
    ...
    echart3.setOption(_objectSpread({}, echartOptions.lineNoAxis, {}, {
      series: [{
        data: [40, 80, 20, 90, 30, 80, 40, 90, 20, 80, 30, 45, 50, 110, 90, 145, 120, 135, 120, 140, 50, 110, 90, 145, 120, 135, 120, 140],
