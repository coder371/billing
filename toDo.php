<?php require_once "./inc/static/head.php"; ?>
                            ...
                            <div class="card-body">
                                ...
                                <form class="create-items">
                                    <div class="input-group mb-3">
                                        <input class="form-control" id="todo-list-item" type="text" placeholder="What do you need to do today?" />
    ...
    <link rel="stylesheet" href="../../dist-assets/css/plugins/animate.css" />
    <script src="../../dist-assets/js/scripts/todo.script.min.js"></script>
</body>
